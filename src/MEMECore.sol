...
contract MetaNodeCore is IMetaNodeCore, Initializable, UUPSUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     * @param virtualBNBReserve 初始虚拟BNB储备（定价基准）
     * @param virtualTokenReserve 初始虚拟代币储备（定价基准）  
     * @param percentageBP 初始买入百分比（以基点表示，100基点=1%）
     * 
     * @return tokensOut 可获得的代币数量
     * @return bnbRequired 需要支付的BNB数量
     * @return newBNBReserve 买入后新的虚拟BNB储备
     * @return newTokenReserve 买入后新的虚拟代币储备
     */
